export const SERVICES = [
  {
    ...
    short: 'Confidential, research-driven search for CEOs, C-suite and VP-level leaders who will shape your next chapter.',
    detail:
      'We run a disciplined, confidential process for your most consequential hires — mapping the market, engaging passive leaders who aren’t browsing job boards, and presenting a shortlist vetted against both track record and fit.',
  },
  {
  ...
  },
  {
    ...
    short: 'Director and VP searches built to find operators who can scale with the company, not just fill the seat.',
    detail:
      'Leadership hires carry outsized risk. We assess for judgment under ambiguity, track record of building teams, and alignment with how your company actually operates — not a polished interview performance.',
  },
  {
  ...
  },
  {
    ...
    icon: 'clipboard',
    title: 'Executive Assistant Recruitment',
    short: 'Discreet, high-trust EA and chief-of-staff placements for founders and executive teams.',
    detail:
      'The right executive assistant multiplies a leader’s time. We recruit for judgment, discretion and operational fluency — the qualities that matter once the job starts, not just on a résumé.',
  },
  {
    slug: 'operations-recruitment',
    icon: 'gear',
    title: 'Operations Recruitment',
    short: 'Operators who bring structure to a business as it moves from early traction to repeatable scale.',
    detail:
      'We recruit operations leaders and specialists who know how to build process without slowing the business down — a distinction that matters enormously at scale-up speed.',
  },
  {
    slug: 'sales-recruitment',
    icon: 'trending-up',
    title: 'Sales Recruitment',
    short: 'Revenue leaders and quota-carrying talent who can sell your product in the market you actually operate in.',
    detail:
      'We evaluate sales candidates against your actual sales motion — deal size, cycle length, buyer sophistication — rather than generic quota history that doesn’t transfer.',
  },
  {
    slug: 'marketing-recruitment',
    icon: 'megaphone',
    title: 'Marketing Recruitment',
    short: 'Marketing leaders who understand brand, demand and the discipline of building a category position.',
    detail:
      'Whether you need a first marketing hire or a VP to build a function, we recruit for strategic thinking as much as channel execution.',
  },
  {
  ...
  },
  {
    ...
    short: 'People leaders who can build culture and infrastructure as a company grows past its founding team.',
    detail:
      'We place HR and people-operations leaders who can professionalize a growing organization without losing the culture that made it work in the first place.',
  },
  {
    slug: 'customer-success-recruitment',
    icon: 'heart',
    title: 'Customer Success Recruitment',
    short: 'Retention-minded leaders and specialists who protect the revenue you’ve already won.',
    detail:
      'We recruit customer success and account management professionals who understand that renewal and expansion are earned continuously, not managed at contract time.',
  },
  {
    slug: 'remote-hiring',
    icon: 'globe',
  ...
  },
  {
    ...
    short: 'Cross-border searches across North America, LATAM and Europe for companies expanding beyond one market.',
    detail:
      'We help companies hire across borders with market-specific knowledge of talent pools, compensation norms and hiring practices in each region we work in.',
  },
  {
    slug: 'recruitment-consulting',
    icon: 'bulb',
    title: 'Recruitment Consulting',
    short: 'Advisory support for founders and hiring teams building or rebuilding their own recruiting function.',
    detail:
      'For companies investing in internal recruiting capability, we advise on process, tooling and hiring standards — bringing search-firm discipline in-house.',
  },
  {
    slug: 'hiring-strategy',
    icon: 'target',
    title: 'Hiring Strategy',
    short: 'Org-design and headcount planning that connects hiring decisions to what the business needs to achieve.',
    detail:
