...
export const ui = {
  ...
  es: {
    ...
    'form.need': '¿Para qué posición necesitas ayuda contratando?',
    'form.needSelect': 'Selecciona una opción',
    'form.message': 'Cuéntanos sobre la posición',
    'form.messagePlaceholder': 'Seniority, equipo, plazos, ubicación — lo que sea útil.',
    'form.submit': 'Enviar Mensaje',
    'form.sending': 'Enviando…',
    'form.success': 'Gracias — te contactaremos dentro de un día laborable.',
    'form.error': 'Algo salió mal. Por favor, escríbenos directamente usando el enlace de abajo.',
    'form.notConfigured': 'El envío en línea todavía no está configurado — por favor, escríbenos directamente usando el enlace de abajo.',
    'form.preferEmail': '¿Prefieres email? Escríbenos directamente a',
